    ...
    return (
        ...
        <div className="card">
          <div className="card-body">
            <div className="row">
              <div className="col">
                <h1 className="fw-bold mb-4 text-center card-header" style={{ color: 'black' }}>User Profile</h1>
                <ul className="nav flex-column profile">
                  ...
                  <li className="nav-item" dangerouslySetInnerHTML={{ __html: `Name: ${userInfo.name}` }}></li>
                  <li className="nav-item">
