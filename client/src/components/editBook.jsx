    ...
    render() {
        return (
          <div>
            ...
            {this.renderInput("title", "Prisoner's name")}
              {this.renderSelect("author", "Imprisoned in", this.state.authors)}
              {this.renderSelect("category","Crime" ,this.state.categories)}
              {this.renderInput("publishedDate", "date of imprisonment")}
